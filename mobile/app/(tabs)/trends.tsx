...
const s = StyleSheet.create({
  ...
  chipText: { color: theme.ink2, fontSize: 11, fontWeight: "800", letterSpacing: 0.8, textTransform: "uppercase" },
  ...
  cardLabel: { color: theme.ink2, fontSize: 10, fontWeight: "800", letterSpacing: 1.6, textTransform: "uppercase" },
  ...
  stat: { flex: 1 },
  statLabel: { color: theme.muted, fontSize:10, fontWeight: "800", letterSpacing: 1.2, textTransform: "uppercase" },
  statValue: { color: theme.ink, fontSize: 16, fontWeight: "700", marginTop: 5, fontVariant: ["tabular-nums"] },
  ...
  rangeText: { color: theme.muted, fontSize: 10, fontWeight: "800", letterSpacing: 1.2, textTransform: "uppercase" },
