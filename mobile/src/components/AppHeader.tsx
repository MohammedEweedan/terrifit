...
const s=StyleSheet.create({
  ...
  brand:{height:36,flexDirection:"row",alignItems:"center",gap:8,paddingHorizontal:10},word:{color:theme.ink,fontSize:13,fontWeight:"900",letterSpacing:2.4},
