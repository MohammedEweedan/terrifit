...
export function TerrifitFooter({locale,copy}:{locale:Locale;copy:Dictionary}) {
  const detail=marketingDetails[locale]; const ui=marketingUi[locale];
  ...
  const columns=[
    [copy.footer.productTitle,[[ui.nav[0],"platform"],[ui.nav[2],"maps"],[detail.band[0],"band"],[ui.nav[4],"shop"]]],
